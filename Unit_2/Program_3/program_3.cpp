...
int main() {
    ...
    fleet.push_back(make_unique<Truck>("V101", "MH12-XY-7741", 14.0));
    fleet.push_back(make_unique<DeliveryVan>("V102", "MH12-DV-3325", 75));
    fleet.push_back(make_unique<Bike>("V103", "MH12-BK-9081", false));
