...
int main() {
    ...
    sensors.emplace_back("F201", 62.4, "07:30 AM");
    sensors.emplace_back("F202", 29.7, "07:30 AM");
    sensors.emplace_back("F203", 71.9, "07:30 AM");
    sensors.emplace_back("F204", 40.1, "07:30 AM");
    ...
    sensors[0].updateReading(58.9, "08:30 AM");
